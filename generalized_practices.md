...
- Explain and modify rule: the student must explain AI code in their own words and must test and modify it, not copy it unchanged ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [4](https://www.cs.cmu.edu/~mdtaylor/113/S26/)).
...
- One step: the specification is written without AI before the coding agent sees it, because "the quality of your planning affects the quality of the AI's output" ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [15](https://www.cs.cmu.edu/~mdtaylor/113/S26/hw8.html)).
...
- Process reflection after each large project ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [8](https://www.cs.cmu.edu/~mdtaylor/113/S26/project3.html)).
...
- Policy rule: test and modify what the AI produces, explain it in your own words ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [4](https://www.cs.cmu.edu/~mdtaylor/113/S26/)).
...
Variants:
- Standing right to ask any student to explain any submission at any time, stated inside the AI policy; plus an in-person oral exam on the capstone ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [5](https://www.cs.cmu.edu/~mdtaylor/113/S26/), [13](https://www.cs.cmu.edu/~mdtaylor/113/S26/project3.html)).
...
- Grade "pending" until a check-in interview covers the code, the design decisions, and what was AI-generated versus the student's own ([UCSD](courses/ucsd-cse190-sp26-generative_ai_and_programming.md) [17](https://ucsd-cse-115-215.github.io/sp26/index.html)).
...
- Do not paste the assignment brief into the AI, so the student writes their own requirements ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [10](https://www.cs.cmu.edu/~mdtaylor/113/S26/hw6.html)).
...
- Every intervention during a hands-off agent build is logged and becomes evidence of specification quality ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [16](https://www.cs.cmu.edu/~mdtaylor/113/S26/hw8.html)). The README and prompt log must match the submitted code; a generic AI-generated README or a log that does not match the code lowers the grade ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [9](https://www.cs.cmu.edu/~mdtaylor/113/S26/hw6.html)).
...
- Short presentation on how AI helped and where it did not ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [12](https://www.cs.cmu.edu/~mdtaylor/113/S26/project1.html)).
...
**Courses: 4** ([MIT](courses/mit-61040-fa25-software_design.md), [CMU 17-316](courses/cmu-17316-fa25-ai_tools_for_software_development.md), [UW](courses/uw-cse403-wi26-software_engineering.md), [Stanford](courses/stanford-cs146s-fa25-modern_software_developer.md)).
...
- Short in-person presentation on how AI helped and where it did not ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [12](https://www.cs.cmu.edu/~mdtaylor/113/S26/project1.html)).

Ideas addressed: 5-discovery. The [CMU 17-316](courses/cmu-17316-fa25-ai_tools_for_software_development.md) essays are also counted under practice 4 (written without AI) and practice 9 (concrete-example bar).
...
- A fresh agent session with no memory of the build reviews the code against the specification ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [17](https://www.cs.cmu.edu/~mdtaylor/113/S26/hw8.html)).
...
**Courses: 3** ([Stanford](courses/stanford-cs146s-fa25-modern_software_developer.md), [CMU 17-316](courses/cmu-17316-fa25-ai_tools_for_software_development.md), [UMD](courses/umd-cmsc398z-fa25-effective_ai_coding_assistants.md)).
...
Ideas addressed: 5-discovery, 2-context (mob sessions train turning a request into an instruction for the LLM). [Stanford](courses/stanford-cs146s-fa25-modern_software_developer.md) [31](https://github.com/mihail911/modern-software-dev-assignments/blob/master/week8/assignment.md) is also counted under practice 9.
...
- One assignment: hands-off build from a student-written spec, every intervention logged ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [16](https://www.cs.cmu.edu/~mdtaylor/113/S26/hw8.html)).
...
**Courses: 1** ([UMD](courses/umd-cmsc398z-fa25-effective_ai_coding_assistants.md)).

Students ask the agent to analyze many data files and summarize, instead of reading them by hand; the student keeps the question and the decision ([UMD](courses/umd-cmsc398z-fa25-effective_ai_coding_assistants.md) [15](https://github.com/billpugh/cmsc398z-student-downloads/blob/main/week9/README.md)).
...
**Courses: 1** ([UCSD](courses/ucsd-cse190-sp26-generative_ai_and_programming.md)).

When a task has no single correct answer, another LLM call may score it, but the student must check the judge's verdicts by hand on several examples first ([UCSD](courses/ucsd-cse190-sp26-generative_ai_and_programming.md) [15](https://ucsd-cse-115-215.github.io/sp26/assignments/agent-assignment.html)). Applied to the student's product, not to their own workflow.
...
A survey after each assignment asks how much of the code the student read and understood, how satisfied they were, and what their AI workflow was, and collects free-text advice. Staff publish the results and the students' advice grouped into themes, so the practices a class discovers itself carry over to the next cohort. The published scores also show which workflows lowered understanding ([CMU 15-113](courses/cmu-15113-sp26-effective_coding_with_ai.md) [18](https://www.cs.cmu.edu/~mdtaylor/113/S26/bestPractices.html)).
